...
class Game:
    ...
    def draw_rect(self, x0, y0, width, height, color):
        ...
        pygame.draw.rect(self.window, color, (21 + (x0 - 1) * self.size, 21 + (y0 - 1) * self.size, width * self.size, height * self.size - 1))
        pygame.display.update()
                ...
                if event.type == pygame.QUIT:
                    ...
                    if 520 > x > 20 and 20 < y < 520:
                        ...
                        if pygame.mouse.get_focused():
                            pygame.draw.rect(
                                self.window, GREEN, (x - 10, y - 10, 20, 20))
                        pygame.display.update()
