...
class TestLibs(TestCase):
    ...
    def test_has_interception_single(self):
        b = GameField(50, 50)
        self.assertEqual(b.hasInterceptionSingle(Square(0, 0, 2, 2, 0), Square(3, 3, 4, 4, 0)), False)

    def test_has_interception_single_2(self):
        b = GameField(50, 50)
        self.assertEqual(b.hasInterceptionSingle(Square(0, 0, 3, 3, 0), Square(2, 2, 4, 4, 0)), True)
